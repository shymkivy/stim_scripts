...
acquisition_file_name = 'ac_mapping';
...
%% saving stuff
save([acquisition_file_path, '_stim_data'], 'trials','duration', 'isi', 'modulation_amp', 'num_freqs', 'start_freq', 'increase_factor', 'stim_times', 'stim_types', 'synch_pulse_times', 'synch_pause_time', 'use_LED_as_lighsource', 'pretrial_LED_pulse', 'pretrial_pulse_duration', 'pretrial_pulse_wait', 'pure_tone');
