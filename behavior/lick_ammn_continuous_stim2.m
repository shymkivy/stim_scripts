...
ops.paradigm_trial_num = [400 600 600];%[800, 1200, 1200];                   % how many trials for each paradigm
ops.paradigm_MMN_pattern = [0,4, 4];                       % which patterns for MMN/flip (controls are ignored)
                                                            % 1= horz/vert; 2= 45deg;
% ------ MMN params ------
...
ops.MMN_patterns = [3,6; 4,7; 9,5; 3,5];
