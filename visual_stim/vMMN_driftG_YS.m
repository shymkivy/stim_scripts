...
ops.paradigm_trial_num = [10, 10, 10];                   % how many trials for each paradigm
...
ops.inter_paradigm_pause_time = 5;                         % how long to pause between paragigms
ops.MMN_probab=[0.125*ones(1,20) .2 .25 .5 1];                % probability of deviants   % MMN_probab=[.01 .01 .02 .1 .1 .1 .1 .5 .5 .5 1];   % jordan's probab
% ------ Other ------
