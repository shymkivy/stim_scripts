...
mon = Monitor(resolution=(1200, 1920), dis=15., mon_width_cm=52., mon_height_cm=32., refresh_rate=165)
ind = Indicator(mon)
ds = DisplaySequence(log_dir='C:/data', is_by_index=True)

dgc = stim.DriftingGratingCircle(monitor=mon, indicator=ind, background=0.,
                                 coordinate='degree', center=(0, 60), sf_list=(0.02,),
                                 tf_list=(4.0, 2.0), dire_list=(45.,), con_list=(0.8,), radius_list=(180.,),
