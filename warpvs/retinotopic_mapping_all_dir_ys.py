...
mon_height_cm = 21.5  # enter your monitors height in cm
...
ks_flicker_frame = mon_refresh_rate/6      # 10 for 60 hz
ks_sweep_width = 20.
ks_step_width = 0.15        # adjust sweep speed
ks_sweep_frame = 1
ks_iteration = 1            # number of repeats
# =================================================================================
...
mon = Monitor(resolution=mon_resolution, dis=mon_dis, mon_width_cm=mon_width_cm,
              ...
              downsample_rate=mon_downsample_rate, refresh_rate=mon_refresh_rate)
# mon.plot_map()
# plt.show()
# =================================================================================
