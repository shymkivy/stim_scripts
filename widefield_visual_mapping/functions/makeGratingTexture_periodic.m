function [Gtxtr, TDim] = makeGratingTexture_periodic(Pstate, Mstate, screenPTR, screenNum)
...
%%%%%%
%%%%%%BETA VERSION
[sdom tdom x_ecc y_ecc] = makeGraterDomain_beta(Mstate, P, xN,yN,P.ori,P.s_freq,P.t_period,P.altazimuth);%orig
...
%     end
    AZ2 = P.altazimuth;
    [sdom2 tdom2 x_ecc2 y_ecc2] = makeGraterDomain(Mstate, P, xN,yN,P.ori2,P.s_freq2,P.t_period,AZ2);
end
...
if ~P.separable
    ...
    for i = 1:length(tdom)
        ...
        Im = makePerGratFrame_insep(P, sdom,tdom,i,1);
        
        if P.plaid_bit
            Im = makePerGratFrame_insep(P, sdom2,tdom2,i,2) + Im;
        end
...
%                 noiseIm = makeNoiseIm(size(Im),nwx,nwy,P.noise_type);
                ...
                noiseIm = makeNoiseIm_beta(Mstate, size(Im),P,x_ecc,y_ecc);
...
%         frame1=frame1+1;
    ...
    [amp temp] = makeSeparableProfiles(Mstate, P, tdom,sdom,x_ecc,y_ecc,1);
    if P.plaid_bit
        [amp2 temp2] = makeSeparableProfiles(Mstate, P, tdom2,sdom2,x_ecc2,y_ecc2,2);
    end
