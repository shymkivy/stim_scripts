function playgrating_flashHartley(Mstate, Pstate, screenPTR, screenNum, loopTrial, Gtxtr, Masktxtr, TDim, domains, probRatios, Stxtr)
...
[SyncLoc, SyncPiece] = f_get_sync_loc(screenRes, Mstate); %yuriy
