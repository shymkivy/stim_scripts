function playmapper(Mstate, Pstate, screenPTR, screenNum)
...
[L W] = getbarDim(Mstate, state,valdom,pixpercmX,pixpercmY);
Im = ones(L,W);
...
function [L W] = getbarDim(Mstate, state,valdom,pixpercmX,pixpercmY)
