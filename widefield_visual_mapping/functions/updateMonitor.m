function Mstate = updateMonitor(Mstate, screenPTR)
...
switch Mstate.monitor
   ...
   case '40in'  
    ...
    case "YS"
        Mstate.screenXcm = 34.5; % left eye screen in VR, 10 cm away
        Mstate.screenYcm = 21.5;        
        bufLUT = (0:255)/255;
        bufLUT = bufLUT'*[1 1 1];
    case "YS2"
        Mstate.screenXcm = 71; % left eye screen in VR, 10 cm away
        Mstate.screenYcm = 40;        
        bufLUT = (0:255)/255;
        bufLUT = bufLUT'*[1 1 1];
end
